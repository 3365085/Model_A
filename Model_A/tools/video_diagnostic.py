...
def load_config(path: Path, *, profile: str = "desktop_rtx") -> dict[str, Any]:
    return load_runtime_config(config_path=path, profile=profile)
...
def main() -> int:
    ...
    config = load_config(args.config, profile=str(args.profile))
