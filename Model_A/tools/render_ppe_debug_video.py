...
from defense.module_a.ppe_postprocess import summarize_ppe_from_detections  # noqa: E402
...
def main() -> int:
    ...
    with csv_path.open("w", newline="", encoding="utf-8-sig") as fp:
        ...
        while True:
            ...
            ppe = summarize_ppe_from_detections(detections, frame_shape=frame_640.shape[:2])
            tracks = stabilizer.update(detections, ppe, frame_shape=frame_640.shape[:2])
